/*
 * drivers/cpufreq/cpufreq_interactive_profiles.h - Profiles
 *
 ...
 * ------------------------------------------------------------------------------------------------------------------------------------------
 * -  (8)'zzperf' -> ZaneZam Performance  -> all you can get from interactive in terms of performance but still has the fast                    -
...
struct interactive_profile interactive_profiles[] = {
	{
		1,		// Default Profile
